...
export async function PUT(request, { params }) {
    ...
    const { newTracking_id: tracking_id, newOrigin_city: origin_city, newCity_collection: city_collection, newShipping_date: shipping_date, newShipping_time: shipping_time,
